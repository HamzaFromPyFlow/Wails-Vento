    ...
    <>
      ...
      <main className="min-h-screen bg-slate-950 text-slate-100 flex items-center justify-center">
        <div className="text-center">
          {currentRecording?.id ? (
            <p className="text-slate-400">Taking you to your recording…</p>
          ) : (
            <>
              <h1 className="text-xl font-semibold mb-2">No recording</h1>
              <p className="text-slate-400 mb-4">Start a recording first, then open it in the editor.</p>
              <button
              ...
              <button
                ...
                className="ml-3 px-4 py-2 border border-slate-500 rounded-lg text-slate-300 hover:bg-slate-800"
              >
                Recordings
              </button>
            </>
